...
namespace ORB_SLAM2
{
    ...
    */
    ...
    void LocalMapping::ProcessNewKeyFrame()
    {
        ...
        if(sync){
            mpCurrentKeyFrame->ReconstructConnections();
        }
                ...
                if (!pMP->isBad())
                {
                    ...
                    if ((unsigned)pMP->mnFirstKFid != mpCurrentKeyFrame->mnId)
                    {
                        ...
                        if (pRefKF)
                        {
                            ...
                            if(edgeNumber==2){
                                // cout<<"ref set not NULL: "<<pRefKF->mnId<<endl;
                            }
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        if(edgeNumber==2){
                                // cout<<"ref set CurrentKeyframe: "<<mpCurrentKeyFrame->mnId<<endl;
                        }
                    }
        ...
        {
            mpCurrentKeyFrame->UpdateConnections(false);    //setting parent here
        }
        // if(sync){
        //     mpCurrentKeyFrame->ReconstructConnections();
        // }
        ...
        if (sync)
        {
            cout << "KF added in sync: " << mpCurrentKeyFrame->mnId << endl;
        }
