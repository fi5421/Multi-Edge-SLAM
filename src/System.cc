...
// rosbag play ./rgbd_dataset_freiburg1_xyz-2hz-with-pointclouds.bag /camera/rgb/image_color:=/camera/rgb/image_raw /camera/depth/image:=/camera/depth_registered/image_raw
// Edge-SLAM: client
